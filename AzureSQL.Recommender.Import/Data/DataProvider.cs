...
namespace AzureSQL.Recommender.Import.Data
{
    ...
    {
        public static List<Brand> ReadBrands(string generatedDataLocation, string sampleName)
        {
        ...
        public static List<Product> ReadProducts(string generatedDataLocation, string sampleName)
        {
        ...
        public static (List<Person> people, List<Order> orders) ReadPeopleAndOrders(
            string generatedDataLocation, 
            string sampleName)
        {
